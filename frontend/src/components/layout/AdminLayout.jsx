...
const navItems = [
  { path: '/admin/table-de-bord', label: 'Tableau de bord', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6', exact: true },
    ...
    <div className="min-h-screen bg-sand-light flex">
      <aside className={`fixed inset-y-0 left-0 z-50 w-64 bg-ink text-ivory flex flex-col transition-transform duration-300 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 lg:static lg:z-auto`}>
        <div className="p-5 border-b border-ivory/10">
          <Link to="/admin/table-de-bord" className="flex items-center gap-3 no-underline">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 p-4 lg:p-8 overflow-auto">
          <Routes>
            <Route index element={<Navigate to="/admin/table-de-bord" replace />} />
            <Route path="table-de-bord" element={<DashboardPage />} />
